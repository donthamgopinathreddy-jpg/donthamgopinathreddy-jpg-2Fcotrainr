...
export default function NotificationsDropdown() {
  ...
  try {
    notificationsData = useNotifications(userProfile?.id);
  } catch (err) {
    setHasError(true);
  }

  const { notifications, unreadCount, loading, markAsRead, markAllAsRead, deleteNotification } = notificationsData;
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 w-5 h-5 bg-gradient-to-br from-red-500 to-pink-500 text-white text-xs rounded-full flex items-center justify-center font-bold">
