...
import { X, Bell, MapPin, Camera, Mic, Phone, CheckCircle, AlertCircle } from "lucide-react";
...
export default function PermissionsModal({ isOpen, onClose }: PermissionsModalProps) {
  ...
  const [requestedPermission, setRequestedPermission] = useState<PermissionType | null>(null);
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-4 space-y-3">
            ...
            <div className="space-y-3 mt-4">
              {permissionsList.map(({ type, icon: Icon, label, description }) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 flex-shrink-0 mt-1 ${isGranted ? "text-green-500" : "text-gray-400"}`} />
