import { Activity, Droplet, Flame, Apple, TrendingUp, Calendar, Heart, Bell, Settings, MoreVertical, MessageSquare, Share2, Moon, Sun } from "lucide-react";
    ...
    <div className={`min-h-screen ${bgClass} transition-colors duration-300`}>
          ...
          <div className="flex items-start justify-between">
            <div className="flex gap-4 items-start flex-1">
              ...
              <div className="flex-1 pt-2">
                <h1 className={`text-2xl font-bold ${textClass}`}>Alex Turner</h1>
      ...
      <div className="px-6 pb-24 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <button onClick={() => alert("Steps updated!")} className="bg-gradient-to-br from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
          ...
          <button onClick={() => alert("Calories tracked!")} className="bg-gradient-to-br from-red-400 to-red-500 hover:from-red-500 hover:to-red-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
            <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => alert("Water logged!")} className="bg-gradient-to-br from-cyan-400 to-cyan-500 hover:from-cyan-500 hover:to-cyan-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
            <div className="flex items-center justify-between mb-3">
              <Droplet className="w-8 h-8 group-hover:scale-110 transition-transform" />
              <span className="bg-white/20 px-3 py-1 rounded-full text-sm font-semibold">↑ 2%</span>
            </div>
        ...
        {/* Quick Actions */}
        <div className="mb-8">
          <h2 className={`text-2xl font-bold ${textClass} mb-6`}>Quick Access</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button onClick={() => alert("Track your meals!")} className="bg-gradient-to-br from-orange-400 to-amber-500 hover:from-orange-500 hover:to-amber-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
            ...
            <button onClick={() => alert("Find trainers now!")} className="bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
            ...
            <button onClick={() => alert("Join the community!")} className="bg-gradient-to-br from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
            ...
            <button onClick={() => alert("View achievements!")} className="bg-gradient-to-br from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group">
              <TrendingUp className="w-8 h-8 mb-3 group-hover:scale-110 transition-transform" />
        ...
        <div className={`${cardClass} border rounded-2xl p-6 shadow-lg mb-8`}>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-orange-500 text-sm font-semibold">🔥 Keep it up!</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl p-4 border-l-4 border-orange-500">
              <p className={`${subtextClass} text-sm font-medium`}>Current Streak</p>
            ...
            <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl p-4 border-l-4 border-purple-500">
              <p className={`${subtextClass} text-sm font-medium`}>Longest Streak</p>
            ...
            <div className="bg-gradient-to-br from-cyan-100 to-cyan-200 rounded-xl p-4 border-l-4 border-cyan-500">
              <p className={`${subtextClass} text-sm font-medium`}>Workouts This Week</p>
        ...
        {/* Weekly Activity */}
        <div className={`${cardClass} border rounded-2xl p-6 shadow-lg mb-8`}>
          <h2 className={`text-xl font-bold ${textClass} mb-6`}>Weekly Activity</h2>
          <div className="space-y-4">
            {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, idx) => (
              <div key={day} className="flex items-center justify-between group">
                <span className={`${subtextClass} font-medium w-12`}>{day}</span>
                ...
                <span className={`font-bold text-sm w-16 text-right ${textClass}`}>{Math.random() * 10 + 5 | 0}k</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className={`${cardClass} border rounded-2xl p-6 shadow-lg`}>
          <div className="flex items-center justify-between mb-6">
            ...
            <button onClick={() => alert("View all posts!")} className="text-blue-600 hover:text-blue-700 text-sm font-semibold transition-colors">
              View All →
            </button>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={idx} className={`p-4 rounded-xl ${darkMode ? "bg-gray-700" : "bg-gray-100"} hover:shadow-md transition-all border ${darkMode ? "border-gray-600" : "border-gray-200"} group cursor-pointer`}>
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className={`font-semibold ${textClass} group-hover:text-blue-600 transition-colors`}>{post.author}</p>
                      <p className={`${subtextClass} text-xs`}>{post.time}</p>
                    </div>
                  </div>
                  <button className={`p-2 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors`}>
                ...
                {post.image && (
                  <div className={`w-full h-40 ${darkMode ? "bg-gray-600" : "bg-gray-300"} rounded-lg mb-3 flex items-center justify-center ${subtextClass}`}>
                    [Transformation Photo]
                  </div>
                )}

                <div className="flex items-center gap-4 pt-3 border-t border-gray-300 dark:border-gray-600">
                  <button onClick={() => alert("Liked!")} className="flex items-center gap-2 text-gray-500 hover:text-red-500 transition-colors group/btn">
                    <Heart className="w-4 h-4 group-hover/btn:fill-red-500 transition-all" />
                    <span className="text-xs">{post.likes}</span>
                  </button>
                  <button onClick={() => alert("Comment clicked!")} className="flex items-center gap-2 text-gray-500 hover:text-blue-500 transition-colors">
                    <MessageSquare className="w-4 h-4" />
                    <span className="text-xs">{post.comments}</span>
                  </button>
                  <button onClick={() => alert("Shared!")} className="flex items-center gap-2 text-gray-500 hover:text-green-500 transition-colors">
      ...
      <div className={`fixed bottom-0 left-0 right-0 ${cardClass} border-t shadow-lg px-6 py-4`}>
        <div className="max-w-6xl mx-auto flex justify-around">
          <button onClick={() => alert("Home selected")} className="flex flex-col items-center gap-2 p-3 rounded-xl text-blue-600 font-semibold hover:bg-blue-100 dark:hover:bg-gray-700 transition-colors">
            <Activity className="w-6 h-6" />
            <span className="text-xs">Home</span>
          </button>
          <button onClick={() => alert("Discover selected")} className={`flex flex-col items-center gap-2 p-3 rounded-xl ${subtextClass} font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors`}>
            <TrendingUp className="w-6 h-6" />
            <span className="text-xs">Discover</span>
          </button>
          <button onClick={() => alert("Messages selected")} className={`flex flex-col items-center gap-2 p-3 rounded-xl ${subtextClass} font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors`}>
            <MessageSquare className="w-6 h-6" />
            <span className="text-xs">Messages</span>
          </button>
          <button onClick={() => alert("Profile selected")} className={`flex flex-col items-center gap-2 p-3 rounded-xl ${subtextClass} font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors`}>
