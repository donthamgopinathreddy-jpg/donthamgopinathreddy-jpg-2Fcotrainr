    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 pb-24">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-gray-200 shadow-sm">
        <div className="max-w-[430px] mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-gray-900">Weekly Water</h1>
        </div>
      </div>
          ...
          <div className="flex gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mt-2">
                {daysGoalMet >= 5
                  ? "💧 Great hydration! Keep drinking water."
                  : daysGoalMet >= 3
                    ? "💪 Good progress! Drink more water."
                    : "💧 Increase your water intake daily."}
              </p>
            </div>
          </div>
        </div>
