...
import { Check, Lock, X, CreditCard, ArrowLeft, Sparkles } from "lucide-react";
...
export default function Upgrade() {
  ...
  const currentPlan = (userProfile?.subscription_plan || "free") as
    | "free"
    | "basic"
    | "premium";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          >
            Upgrade to unlock premium features and accelerate your fitness
            journey
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {/* FREE PLAN */}
          <div
            className={`rounded-3xl p-8 relative transition-all hover:shadow-xl ${
              currentPlan === "free"
                ? theme === "dark"
          ...
          >
            ...
            {currentPlan === "premium" ? (
              <button
                className={`w-full py-3 font-semibold rounded-xl cursor-default ${
                  theme === "dark"
        ...
        {selectedPlan && currentPlan !== selectedPlan && (
          <div
            className={`rounded-3xl p-8 max-w-md mx-auto w-full ${
              theme === "dark"
          ...
          >
            ...
            >
              ...
              {processingPayment
                ? "Processing..."
                : `Pay Now for ${selectedPlan.charAt(0).toUpperCase() + selectedPlan.slice(1)}`}
            </button>
          </div>
        )}
