...
import { Footprints, Droplets, Flame, Users, Briefcase, Activity, MessageSquare, ChevronDown, TrendingUp, Award, Calendar, Target, Video, CheckCircle, User, Heart, Share2, MessageCircle as MessageIcon, Newspaper, MapPin, UserCheck, Settings, Copy, Check, Play, Clock, X, Watch, Smartphone } from "lucide-react";
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm font-bold text-orange-600">
                    {displaySteps.toLocaleString()} / {stepsGoal.toLocaleString()}
                  </span>
                </div>
