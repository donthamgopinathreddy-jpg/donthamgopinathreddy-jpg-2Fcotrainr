          ...
          <div className="max-w-md mx-auto px-4 -mt-8 pb-8 relative z-20 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 rounded-2xl p-5 border border-blue-200 hover:shadow-lg hover:shadow-blue-300/50 transition-all space-y-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Video className="w-6 h-6 text-blue-600" />
                    <h3 className="font-bold text-gray-900 text-sm">Video Session</h3>
                  </div>
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-white border-2 border-blue-400 rounded-lg px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary text-sm font-medium placeholder-gray-400"
                    />
                    <button
                      onClick={handleJoinMeeting}
                      className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-5 py-2 rounded-lg font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                      title="Join meeting"
                    >
                      Join
                    </button>
