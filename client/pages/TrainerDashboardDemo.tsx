          ...
          {notificationOpen && (
            <div className="absolute top-16 left-0 w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 space-y-3 z-50">
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                <div
                  onClick={() => alert("New client request!")}
                ...
                <div
                  onClick={() => alert("Session reminder!")}
      ...
      <div className="px-6 pb-24 max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button
              onClick={() => alert("View your clients!")}
              className="bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group"
            >
            ...
            <button
              onClick={() => alert("Schedule a session!")}
              className="bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group"
            >
            ...
            <button
              onClick={() => alert("Check your messages!")}
              className="bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group"
            >
            ...
            <button
              ...
              className="bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 text-white group"
            >
            ...
            {[
              ...
              >
                <div className="flex-1 text-left">
                  <p
                    className={`font-semibold ${textClass} group-hover:text-purple-600 transition-colors`}
                  >
                    {session.client}
                  </p>
      ...
      >
        <div className="max-w-6xl mx-auto flex justify-around">
          ...
          <button
            ...
            className="flex flex-col items-center gap-2 p-3 rounded-xl text-purple-600 font-semibold hover:bg-purple-100 dark:hover:bg-gray-700 transition-colors"
          >
