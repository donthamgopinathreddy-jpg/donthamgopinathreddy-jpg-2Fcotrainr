...
export default function TrainerClientDetail() {
  ...
  const bmi =
    Math.round((client.weight_kg / (client.height_cm / 100) ** 2) * 10) / 10;
  const weightRemaining = client.goal_weight_kg
    ? client.goal_weight_kg - client.weight_kg
    : 0;
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <p
                className={`text-xl font-bold ${client.current_stats.weight_progress_kg < 0 ? "text-green-600" : "text-foreground"}`}
              >
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-cyan-200 rounded-lg p-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  {client.video_session_count} completed
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 flex items-center gap-3">
              ...
              <p className="text-2xl font-bold text-green-600">
                {Math.round(
                  (client.sessions_completed / client.total_sessions) * 100,
                )}
                %
              </p>
            </div>
        ...
        <div className="mb-6">
          ...
          <div className="bg-card border border-border rounded-lg p-4 space-y-3">
            <div className="flex justify-between items-center pb-3 border-b border-border">
              ...
              <p className="font-bold text-foreground">
                {client.current_stats.calories_avg_daily} cal
              </p>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-border">
