...
export default function MobileDiscover() {
  ...
  const [selectedFitnesTypes, setSelectedFitnessTypes] = useState<string[]>([]);
    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // Fetch nearby fitness centers (placeholder - API integration later)
    ...
    if (isIOS) {
      ...
      window.open(
        `maps://maps.apple.com/?address=${encodeURIComponent(
          location.address
        )}&q=${encodeURIComponent(location.name)}&ll=${location.lat},${
          location.lng
        }`,
        "_blank"
      );
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="sticky top-0 z-40 bg-background border-b border-border px-4 py-3">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          {activeTab === "trainers"
            ? "Find fitness trainers near you"
            : activeTab === "nutritionists"
            ? "Find nutritionists and dieticians"
      ...
      {activeTab === "fitness_centers" && (
        <div className="px-4 py-3 bg-background border-b border-border">
          <p className="text-sm font-semibold text-foreground mb-3">Fitness Categories</p>
          ...
          <>
              ...
              <div className="mb-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-800 dark:text-red-300 mt-1">
                    Enable location permission in your browser settings to see nearby fitness centers
                  </p>
                  <button
            ...
            {loadingLocations ? (
              <div className="flex flex-col justify-center items-center h-40 gap-3">
                ...
                <p className="text-muted-foreground">Finding nearby fitness centers...</p>
              </div>
              ...
              <div className="space-y-3">
                {filteredFitnessLocations.map((location) => (
                  <div
                    ...
                    className="bg-card rounded-2xl p-4 shadow-sm hover:shadow-md transition-all border border-border cursor-pointer hover:border-orange-400"
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start mb-1">
                          <h3 className="font-bold text-foreground leading-tight pr-2">
                            {location.name}
                          </h3>
                        </div>
